...
import com.example.mhainulhoque.quizapp.ViewHolder.ScoreDetailViewHolder;
...
public class ScoreDetail extends AppCompatActivity {
    ...
    DatabaseReference quetion_score;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quetion_score=database.getReference("Question_Score");
    ...
    adapter =new FirebaseRecyclerAdapter<QuestionScore, ScoreDetailViewHolder>(
            ...
            quetion_score.orderByChild("user").equalTo(viewUser)
